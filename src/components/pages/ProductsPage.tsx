          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <Link href={createPageUrl("Contact")}>
                <Button
                  size="lg"
                  className="bg-amber-500 text-green-900 hover:bg-amber-400 px-8 py-6 text-lg font-semibold rounded-xl group"
                >
                  Order Now
            ...
            >
              <div className="relative aspect-square max-w-lg mx-auto">
                ...
                <div className="relative bg-gradient-to-br from-white/15 to-white/5 rounded-3xl p-10 backdrop-blur-sm border border-white/20">
                  <div className="aspect-square bg-gradient-to-br from-teal-600 to-green-700 rounded-2xl flex flex-col items-center justify-center text-white p-8">
                    <Droplets className="w-24 h-24 mb-4 text-amber-400" />
                    <div className="text-3xl font-bold">SIDDA</div>
                    <div className="text-lg opacity-80">5L Jerrycan</div>
                  </div>
                </div>
              </div>
            </motion.div>
